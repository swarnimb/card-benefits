...
INSERT INTO "new_Benefit" ("category", "createdAt", "description", "id", "name", "resetAnchor", "resetPeriod", "type", "userCardId", "value", "valueUnit") SELECT "category", "createdAt", "description", "id", "name", "resetAnchor", "resetPeriod", "type", "userCardId", "value", "valueUnit" FROM "Benefit";
DROP TABLE "Benefit";
