...
INSERT INTO "new_Benefit" ("activatedAt", "category", "classification", "createdAt", "description", "id", "name", "resetAnchor", "resetPeriod", "setAndForget", "tracked", "type", "userCardId", "value", "valueUnit") SELECT "activatedAt", "category", "classification", "createdAt", "description", "id", "name", "resetAnchor", "resetPeriod", "setAndForget", "tracked", "type", "userCardId", "value", "valueUnit" FROM "Benefit";
DROP TABLE "Benefit";
